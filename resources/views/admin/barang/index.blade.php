                    ...
                    <div class="col-md-12">
                        <div class="card">
                            ...
                            <div class="card-header">
                                ...
                                <a href="{{route('barang.create')}}" class="btn btn-primary pull-right">Tambah</a>
                            </div>
                            <div class="card-body">
                                <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>{{++$i}}</td>
                                            <td>{{$row->kodeBarang136}}</td>
                                            <td>{{$row->namaBarang136}}</td>
                                            <td>{{$row->hargaBarang136}}</td>

                                            <td><a href="{{route('barang.edit', $row->id)}}" class='btn btn-primary'>Edit</a></td>
                                            <td><form action="{{route('barang.destroy', $row->id)}}" method="post">
                                                    @csrf
                                                    @method('DELETE')
